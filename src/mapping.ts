...
export function handlePetOperatorApprovalForAll(
  ...
  // - contract.tokenIdsWithKinship(...)
  // - contract.xpUntilNextLevel(...)
  // - contract.childChainManager(...)
  // - contract.collateralBalance(...)
  // - contract.collateralInfo(...)
  // - contract.collaterals(...)
  // - contract.getAllCollateralTypes(...)
  // - contract.getCollateralInfo(...)
  // - contract.createHaunt(...)
  // - contract.createHauntWithPayload(...)
  // - contract.gameManagerBalance(...)
  // - contract.gameManagerRefreshTime(...)
  // - contract.isGameManager(...)
  ...
  // - contract.previewAavegotchi(...)
  // - contract.getAavegotchiSideSvgs(...)
  // - contract.getItemSvgs(...)
  // - contract.previewSideAavegotchi(...)
  // - contract.keyHash(...)
  // - contract.link(...)
...
// export function handleGameManagerAdded(event: GameManagerAdded): void {}

// export function handleGameManagerRemoved(event: GameManagerRemoved): void {}

// export function handleGrantExperience(event: GrantExperience): void {}

// export function handleItemManagerAdded(event: ItemManagerAdded): void {}

// export function handleItemManagerRemoved(event: ItemManagerRemoved): void {}
...
// export function handleErc20Deposited(event: Erc20Deposited): void {}

// export function handleTransferEscrow(event: TransferEscrow): void {}
...
export function handleTransfer(event: Transfer): void {
  // deposit
  if(event.params._to.equals(vaultAddress)) {
  ...
  // withdraw
  else if(event.params._from.equals(vaultAddress)) {
    let vault = getOrCreateVault(event.params._to);
    let gotchi = getOrCreateAavegotchi(event.params._tokenId);
    gotchi.vault = null;
    gotchi.save();
